...
def desenhar_barra_vida():
    ...
    pygame.draw.rect(tela, vermelho, (largura // 2 - barra_vida_largura // 2, 10, barra_vida_largura, barra_vida_altura))
    pygame.draw.rect(tela, verde, (largura // 2 - barra_vida_largura // 2, 10, barra_vida_largura * vida_percentual, barra_vida_altura))
